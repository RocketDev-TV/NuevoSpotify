...
export declare class MusicManagerResolver {
    ...
    createAlbum(titulo: string, fecha: string, tipo: string, num: number, artistaId: string, imagenUrl?: string): Promise<boolean>;
    updateAlbum(albumId: string, titulo: string, fecha: string, tipo: string, num: number, imagenUrl?: string): Promise<boolean>;
